...
const Login = () => {
    return (
        <div className='min-h-screen flex flex-col md:flex-row'>
            {/* backgroud image */}
            <img src={assets.bgImage} alt=""  className='absolute top-0 -z-10 w-full h-full object-cover'/>
            ...
            <div className='flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40'>
                ...
                <div>
                    ...
                    <p className='text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md'>Connect with global community on pingoup</p>
                </div>
